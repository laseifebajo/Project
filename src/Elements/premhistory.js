...
export class Premhistory extends React.Component {
    ...
    render() {
        return (
            <div>
                <h1>The History Of The Premier League</h1>
                <p>In the early 1990s, English First Division clubs believed that a radical restructuring of football was needed if they and the game in general were to develop and flourish.
                    ...
                    When the Premier League was formed, there was always the intention to reduce the number of clubs to 20 to promote development and excellence at club and international level. This was achieved at the end of the 1994/95 season when four clubs were relegated and just two promoted.</p>
                    
                    <img alt="" src="https://e0.365dm.com/15/07/2048x1152/premier-league-moments-lampard-rooney-aguero_3326259.jpg" width="1200" height="350"/>
            </div>
